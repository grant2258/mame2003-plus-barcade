...
INPUT_PORTS_START( tron )
	...
	PORT_ANALOG( 0xff, 0x00, IPT_DIAL | IPF_REVERSE | IPF_PLAYER7, 50, 10, 0, 0 ) /* map as rotary for now */
...
INPUT_PORTS_START( kroozr )
	...
	PORT_ANALOG( 0xff, 0x00, IPT_DIAL | IPF_REVERSE | IPF_PLAYER7, 40, 10, 0, 0 ) /* map as rotary for now */
INPUT_PORTS_END
