...
#define SNK_JOY1_PORT \
	...
	PORT_ANALOG( 0xf0, 0x00, IPT_DIAL | IPF_PLAYER7, 25, 10, 0, 0 ) \
...
#define SNK_JOY2_PORT \
	...
	PORT_ANALOG( 0xf0, 0x00, IPT_DIAL | IPF_PLAYER8, 25, 10, 0, 0)
...
INPUT_PORTS_START( ftsoccer )
	...
	PORT_ANALOG( 0x7f, 0x00, IPT_DIAL | IPF_PLAYER7, 25, 10, 0, 0 )
	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNUSED )

	PORT_START	/* Only used in the "test mode" in this version */
	PORT_ANALOG( 0x7f, 0x00, IPT_DIAL | IPF_PLAYER8, 25, 10, 0, 0 )
	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNUSED )
