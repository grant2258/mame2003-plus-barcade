...
struct ipd inputport_defaults[] =
{
   ...
   {  IPT_PEDAL                | IPF_PLAYER1, "P1 Pedal 1",            SEQ_DEF_3(JOYCODE_1_PEDAL, CODE_OR, JOYCODE_1_BUTTON8) },
   { (IPT_PEDAL+IPT_EXTENSION) | IPF_PLAYER1, "P1 Auto Release <Y/N>", SEQ_DEF_1(KEYCODE_Y) },
   {  IPT_PEDAL                | IPF_PLAYER2, "P2 Pedal 1",            SEQ_DEF_3(JOYCODE_2_PEDAL, CODE_OR, JOYCODE_2_BUTTON8) },
   { (IPT_PEDAL+IPT_EXTENSION) | IPF_PLAYER2, "P2 Auto Release <Y/N>", SEQ_DEF_1(KEYCODE_Y) },
   {  IPT_PEDAL                | IPF_PLAYER3, "P3 Pedal 1",            SEQ_DEF_3(JOYCODE_3_PEDAL, CODE_OR, JOYCODE_3_BUTTON8) },
   { (IPT_PEDAL+IPT_EXTENSION) | IPF_PLAYER3, "P3 Auto Release <Y/N>", SEQ_DEF_1(KEYCODE_Y) },
   {  IPT_PEDAL                | IPF_PLAYER4, "P4 Pedal 1",            SEQ_DEF_3(JOYCODE_4_PEDAL, CODE_OR, JOYCODE_4_BUTTON8) },
   ...
   {  IPT_PEDAL2                | IPF_PLAYER1, "P1 Pedal 2",            SEQ_DEF_3(JOYCODE_1_PEDAL2, CODE_OR, JOYCODE_1_BUTTON7) },
   { (IPT_PEDAL2+IPT_EXTENSION) | IPF_PLAYER1, "P1 Auto Release <Y/N>", SEQ_DEF_1(KEYCODE_Y) },
   {  IPT_PEDAL2                | IPF_PLAYER2, "P2 Pedal 2",            SEQ_DEF_3(JOYCODE_2_PEDAL2, CODE_OR, JOYCODE_2_BUTTON7) },
   { (IPT_PEDAL2+IPT_EXTENSION) | IPF_PLAYER2, "P2 Auto Release <Y/N>", SEQ_DEF_1(KEYCODE_Y) },
   {  IPT_PEDAL2                | IPF_PLAYER3, "P3 Pedal 2",            SEQ_DEF_3(JOYCODE_3_PEDAL2, CODE_OR, JOYCODE_3_BUTTON7) },
   { (IPT_PEDAL2+IPT_EXTENSION) | IPF_PLAYER3, "P3 Auto Release <Y/N>", SEQ_DEF_1(KEYCODE_Y) },
   {  IPT_PEDAL2                | IPF_PLAYER4, "P4 Pedal 2",            SEQ_DEF_3(JOYCODE_4_PEDAL2, CODE_OR, JOYCODE_4_BUTTON7) },
  ...
  {  IPT_DIAL | IPF_PLAYER7,                "Dial 7",      SEQ_DEF_1(JOYCODE_1_BUTTON5) }, 
  { (IPT_DIAL | IPF_PLAYER7)+IPT_EXTENSION, "Dial 7",      SEQ_DEF_1(JOYCODE_1_BUTTON6) },
  {  IPT_DIAL | IPF_PLAYER8,                "Dial 8",      SEQ_DEF_1(JOYCODE_2_BUTTON5) },
  { (IPT_DIAL | IPF_PLAYER8)+IPT_EXTENSION, "Dial 8",      SEQ_DEF_1(JOYCODE_2_BUTTON6) },
...
void update_analog_port(int port)
{
	...
	switch (type)
	{
		...
		case IPT_PEDAL2:
			axis = PEDAL_AXIS2; is_stick = 1; is_gun=0; check_bounds = 1; break;
		default:
